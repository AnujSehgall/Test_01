...
public class MqttHelper {
    ...
    final String subscriptionTopic = "test1";

    final String username = "rcduaeoh";
    final String password = "hm3O7P_0KiXi";
    public MqttHelper(Context context2){
        mqttAndroidClient2 = new MqttAndroidClient(context2, serverUri, clientId);
    ...
    public void setCallback(MqttCallbackExtended callback) {
        mqttAndroidClient2.setCallback(callback);
    }
